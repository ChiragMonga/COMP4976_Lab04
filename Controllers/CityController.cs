...
namespace Lab04.Controllers
{
    public class CityController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CityId,CityName,ProvinceName,Population")] City city)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CityId,CityName,ProvinceName,Population")] City city)
        {
            if (id != city.CityId)
            {
                return NotFound();
